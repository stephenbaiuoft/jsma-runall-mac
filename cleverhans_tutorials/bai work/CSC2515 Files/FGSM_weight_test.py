...
def evaluate_weight(train_start=0, train_end=50000, test_start=0,
                   test_end=10000, nb_epochs=3, batch_size=128,
                   learning_rate=0.001,
                   clean_train=True,
                   testing=False,
...
def main(argv=None):
    evaluate_weight(nb_epochs=FLAGS.nb_epochs, batch_size=FLAGS.batch_size,
...
if __name__ == '__main__':
    ...
    #                 args=train_params, rng=rng)
    #
    #     model_train(sess, x, y, preds_1, X_train, Y_train, evaluate=evaluate,
    #                 args=train_params, rng=rng)
    #
    #     model_train(sess, x, y, preds_2, X_train, Y_train, evaluate=evaluate,
    #                 args=train_params, rng=rng)
    #
    #
